-- FIX RECONSTRUCTION ENGINE NAMES
...
BEGIN
    FOR q_rec IN (
        ...
        -- 1. Try Keyword Matching for P0 Topics (CORRECTED NAMES)
        ...
        ELSIF v_search_text ~ '(sepse|sepsis|choque séptico)' THEN
            SELECT id INTO resolved_comp_id FROM public.curriculum_registry WHERE curriculum_competency = 'Sepse' LIMIT 1;
        ...
        IF resolved_topic_id IS NOT NULL OR resolved_comp_id IS NOT NULL THEN
            ...
            INSERT INTO public.cvrp_orphan_reconstruction_log (
                ...
                q_rec.id, resolved_topic_id, resolved_comp_id, 'pattern_matching_fixed', 0.95
            );
