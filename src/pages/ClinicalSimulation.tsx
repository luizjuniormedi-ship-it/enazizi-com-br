...
const CLINICAL_TELEMETRY = {
  ...
  DQI: '[DQI_CALCULATED]',
  DQI_INFLATION: '[DQI_INFLATION_DETECTED]',
  DQI_PENALTY: '[DQI_PENALTY_APPLIED]',
  TRANSFER: '[FAR_TRANSFER_CAPTURED]',
  TRANSFER_CONFIDENCE: '[FAR_TRANSFER_CONFIDENCE_CALCULATED]',
  GAIN: '[CLINICAL_GAIN_CALCULATED]',
  OUTCOME: '[SIMULATION_OUTCOME_RECORDED]',
  EVIDENCE: '[CLINICAL_EVIDENCE_UPDATED]',
  CASE_DIFFICULTY: '[CASE_DIFFICULTY_ASSIGNED]',
  ATTRIBUTION: '[ATTRIBUTION_CONFIDENCE_UPDATED]',
};
