...
import { Trophy, Clock, CheckCircle2, XCircle, BookOpen, Sparkles } from "lucide-react";
      ...
      <Card className="border-primary/30 overflow-hidden">
        ...
        <CardContent className="p-5 sm:p-7 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <StatCell icon={<CheckCircle2 className="h-4 w-4 text-primary" />} label="Acertos" value={String(summary.correctAnswers)} />
