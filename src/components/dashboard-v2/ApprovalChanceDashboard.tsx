      ...
      <div className="space-y-6">
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <div className="relative overflow-hidden rounded-[32px] bg-gradient-to-br from-indigo-600/20 to-purple-600/20 border border-white/10 p-8 cursor-help">
          ...
          <TooltipContent>Sua probabilidade estatística de aprovação no ENAMED baseada em toda sua performance acumulada.</TooltipContent>
        </Tooltip>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Tooltip>
            ...
            <TooltipContent>Projeção da sua chance de aprovação daqui a um mês mantendo o ritmo atual.</TooltipContent>
          </Tooltip>
          ...
          <Tooltip>
            ...
            <TooltipContent>Projeção da sua chance de aprovação daqui a dois meses mantendo o ritmo atual.</TooltipContent>
          </Tooltip>
          ...
          <Tooltip>
            ...
            <TooltipContent>Estimativa de prontidão na data prevista do exame oficial.</TooltipContent>
          </Tooltip>
        </div>
          ...
          {enamed.strongAreas.length > 0 && (
            <div className="flex flex-wrap gap-2">
              ...
              {enamed.strongAreas.map(area => (
                <Tooltip key={area}>
                  <TooltipTrigger asChild>
                    <Badge variant="secondary" className="bg-emerald-500/10 text-emerald-500 border-emerald-500/20 cursor-help">
                      {area}
                    </Badge>
                  </TooltipTrigger>
                  <TooltipContent>Você possui alta performance e retenção neste tema.</TooltipContent>
                </Tooltip>
              ))}
            </div>
          )}
          ...
          {enamed.weakAreas.length > 0 && (
            <div className="flex flex-wrap gap-2">
              ...
              {enamed.weakAreas.map(area => (
                <Tooltip key={area}>
                  <TooltipTrigger asChild>
                    <Badge variant="secondary" className="bg-red-500/10 text-red-500 border-red-500/20 cursor-help">
                      {area}
                    </Badge>
                  </TooltipTrigger>
                  <TooltipContent>Tema com baixa performance que está reduzindo sua chance de aprovação global.</TooltipContent>
                </Tooltip>
              ))}
            </div>
          )}
