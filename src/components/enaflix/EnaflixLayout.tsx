...
export function EnaflixLayout({ children }: Props) {
  ...
  const immersiveRoutes = ["/dashboard/mentor", "/dashboard/tutor", "/mentor", "/tutor", "/study/tutor", "/dashboard/sessao-estudo", "/dashboard/clinical-simulation", "/dashboard/simulacao-clinica", "/dashboard/plantao", "/dashboard/anamnese"];
