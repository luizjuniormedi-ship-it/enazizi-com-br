...
export type TelemetryEventName =
  ...
  | 'planner_opened'
  | 'planner_topic_opened'
  | 'planner_printed'
  | 'longitudinal_plan_generated'
  | 'planner_task_started'
  | 'planner_task_completed'
  | 'planner_execution_resumed'
  | 'planner_execution_abandoned'
  | 'tutor_opened_from_planner'
  | 'tutor_context_loaded'
  | 'longitudinal_sync_completed'
  | 'metrics_opened'
  | 'progress_opened'
  | 'library_opened'
  | 'navigation_error'
